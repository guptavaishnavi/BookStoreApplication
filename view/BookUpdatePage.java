...
import controller.BookUpdatePageController;
import controller.MyWindowListener;

public class BookUpdatePage extends Frame{
	...
	{
		this.setBounds(300,300, 220, 300);
		...
		BookUpdatePageController bpc = new BookUpdatePageController(this);
